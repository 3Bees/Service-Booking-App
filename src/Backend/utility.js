...
export async function testNotification(collection) {
...
export const getFCMToken = async id => {
...
export async function saveDataWithinCollection(collection, doc, jsonObject) {
  await db
    .collection(collection)
    .doc(doc)
...
export async function getDocByKeyValue(collection, key, value, filter = '==') {
  let data = [];
...
export async function getDataWithSnapShot(collection) {
  return new Promise((resolve, reject) => {
    function onResult(QuerySnapshot) {
      ...
      //   console.log(`Got ${collection} collection result.`);
    }
